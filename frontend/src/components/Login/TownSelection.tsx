...
export default function TownSelection({ doLogin }: TownSelectionProps): JSX.Element {
  ...
  const [oldSignUpDisplay, NewSignUpDisplay] = useState<boolean>(false);
  const [oldLoginDisplay, NewLoginDisplay] = useState<boolean>(false);
  const [oldTownDisplay, NewTownDisplay] = useState<boolean>(false);
  ...
  return (
    <>
      <form>
        <Stack>
          <Box p='4' borderWidth='1px' borderRadius='lg' hidden={!oldSignUpDisplay}>
          ...
          <Box p='4' borderWidth='1px' borderRadius='lg' hidden={oldLoginDisplay}>
            <Heading as='h2' size='lg'>
              LOGIN
            </Heading>
            <FormControl>
          ...
          <Box
            borderWidth='1px'
            borderRadius='lg'
            style={{ visibility: oldTownDisplay ? 'visible' : 'collapse' }}>
...
//       setUserName(loginEmail);
//       NewLoginDisplay(!oldLoginDisplay);
//       NewTownDisplay(!oldSignUpDisplay);
//     } catch (err) {
//       toast({
//         title: 'Unable to sign in',
//         description: err.toString(),
